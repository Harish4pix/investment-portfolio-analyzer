...
export default function Benchmark({ portfolio }) {
  return (
    <div className="empty-card animate-fadeUp">
      <Scale size={38} color="#5b6b85" strokeWidth={1.5} style={{ margin: '0 auto' }} />
      <h2 style={{ marginTop: 18, fontSize: 19, fontWeight: 600, color: '#e8edf5' }}>Benchmark</h2>
